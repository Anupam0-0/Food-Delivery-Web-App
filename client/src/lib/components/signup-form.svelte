	...
	<Card.Content>
		<div class="grid gap-4">
			<div class="grid gap-2">
				...
				<Input id="fullName-{id}" type="name" placeholder="Larry" required />
			</div>
			<div class="grid gap-2">
			...
			<div class="grid gap-2">
				<div class="flex items-center">
					...
					<button
						...
						class="ml-auto inline-block cursor-pointer text-sm underline"
					>
			...
			<Button type="submit" class="w-full cursor-pointer">Create a Account</Button>
